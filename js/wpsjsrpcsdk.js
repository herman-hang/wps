(function (global, factory) {
    ...
    function InitWpsCloudSvr() {
        var src="ksoWPSCloudSvr://start=RelayHttpServer"
        if (serverId == undefined){
           src = "ksoWPSCloudSvr://start=RelayHttpServer"//是否启动wps弹框
        }else{
            src = "ksoWPSCloudSvr://start=RelayHttpServer" + "&serverId=" + serverId //是否启动wps弹框
        }
        var iframe=document.getElementById("ksowps");
        if(iframe){
